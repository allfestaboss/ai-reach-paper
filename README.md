...
| **Version (v1.2.1)** | **`10.5281/zenodo.21879188`** ← 再現性を担保する場合はこちら |
| Version (v1.2.0) | `10.5281/zenodo.21872108` |
| Version (v1.1.0) | `10.5281/zenodo.21863786` |
| Version (v1.0.0) | `10.5281/zenodo.21862232` |

**v1.2.1 で何が変わったか。** v1.2.0 が「分離できていない」と書いたシリーズ最大の資料効果を、**論じるのではなく測って分離した**（漏れを消した資料で3走、いずれも 100 で不変）。開示されていた4行は点数を支えていなかった。

**v1.2.0 で何が変わったか。** v1.1.0 で報告した課題文の欠陥を**直した行為が、
次の欠陥を持ち込んだ**（修理を説明する注記が13問中4問の答えを印字していた。
腕の3走すべてが申告し、検査5つは全部すり抜けた）。8本を横断で監査すると、
腕が誰も申告していない2本でも同じ型が出た。あわせて**凍結中に運用側自身が欠陥になった**
記録と、2つの数字の限定（シリーズ最大の資料効果、および「コスト比較は無効」の撤回）を
入れた。詳細は [リリースノート](https://github.com/allfestaboss/ai-reach-paper/releases/tag/v1.2.0)。
